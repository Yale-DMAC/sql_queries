...
WHERE bib_text.bib_format in ('kc', 'km')
AND (marc_fields.marc_300 like '%linear%'
        OR marc_fields.marc_300 like '%box%' 
        OR marc_fields.marc_300 like '%album%'
        OR marc_fields.marc_300 like '%scrapbook%'
        OR marc_fields.marc_300 like '%photograph%'
